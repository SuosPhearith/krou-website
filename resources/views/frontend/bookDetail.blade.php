            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="md:col-span-2">
                    <div class="border rounded-lg shadow-lg">
                        ...
                        <div class="p-4">
                            <!-- PDF Embed -->
                            <embed src="{{ config('app.file_base_url') . $book->file_uri }}" type="application/pdf"
                    ...
                    <div class="border rounded-lg shadow-lg mb-6">
                        ...
                        <div class="p-4">
                            <ul class="space-y-2 text-gray-800">
                                <li>
                                    <span class="font-semibold">ចំណងជើង:</span> {{ $book->title }}
                                </li>
                                <li>
                                    <span class="font-semibold">ថ្ងៃចេញផ្សាយ:</span> {{ $book->published_date }}
                                </li>
                                <li>
                                    <span class="font-semibold">មកពីសាលា:</span> {{ $book->coming_from }}
                                </li>
                                <li>
                                    <span class="font-semibold">សាស្រ្តាចារ្យ:</span> {{ $book->lecturer }}
                                </li>
                            </ul>
                        </div>
                    </div>
